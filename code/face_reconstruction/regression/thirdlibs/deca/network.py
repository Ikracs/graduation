...
def load_ResNet50Model():
    ...
    copy_parameter_from_resnet(model, models.resnet50(weights=None).state_dict())
    return model

def load_ResNet101Model():
    model = ResNet(Bottleneck, [3, 4, 23, 3])
    copy_parameter_from_resnet(model, models.resnet101(weights=models.ResNet101_Weights.DEFAULT).state_dict())
    return model

def load_ResNet152Model():
    model = ResNet(Bottleneck, [3, 8, 36, 3])
    copy_parameter_from_resnet(model, models.resnet152(weights=models.ResNet152_Weights.DEFAULT).state_dict())
    return model
